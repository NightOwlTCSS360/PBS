        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if (email.isEmpty() || password.isEmpty() || firstName.isEmpty() || lastName.isEmpty()) {
                    JOptionPane.showMessageDialog(SignUpPanel.this, "Please fill out all fields.", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }

                if (!password.equals(new String(jPasswordField2.getPassword()))) {
                    JOptionPane.showMessageDialog(SignUpPanel.this, "Passwords do not match.", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                // Name validation
                System.out.println(firstName.matches("\\d+"));
                if (firstName.matches(".*[^a-zA-Z].*") || lastName.matches(".*[^a-zA-Z].*")) {
                    // Display error message
                    JOptionPane.showMessageDialog(SignUpPanel.this,
                            "Either First or Last Name Contains a Non-Alphabetical Character",
                            "Sign Up Error",
                            JOptionPane.ERROR_MESSAGE);
                    return; // end function
                }
                ...
                if (result) {
                    JOptionPane.showMessageDialog(SignUpPanel.this, "Sign up successful.", "Success",
                            JOptionPane.INFORMATION_MESSAGE);
                    jButton4ActionPerformed(evt);

                } else {
                    JOptionPane.showMessageDialog(SignUpPanel.this, "Sign up failed.", "Error",
                            JOptionPane.ERROR_MESSAGE);
                }
