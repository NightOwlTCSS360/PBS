...
public class ProjectList extends javax.swing.JPanel {
    ...
    private void ProjectAddActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void createProjectButtoncreateProjectAction(java.awt.event.ActionEvent evt) {
        try {
    ...
    private void cancelProjectButtoncancelProjectAction(java.awt.event.ActionEvent evt) {
        createProjectDialog.dispose();
    }
